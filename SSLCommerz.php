        ...
        if ($post_data != '' && is_array($post_data)) {
            ...
            if ($load_sslc) {
                if (isset($this->sslc_data['status']) && $this->sslc_data['status'] == 'SUCCESS') {
                    if (!$get_pay_options) {
                        if (isset($this->sslc_data['redirectGatewayURL']) && $this->sslc_data['GatewayPageURL'] != '') {
                            wp_redirect($this->sslc_data['redirectGatewayURL']);
                             echo "
                                <script>
                                    window.location.href = '" . $this->sslc_data['redirectGatewayURL'] . "';
                                </script>
                            ";
                            exit;
                        } else {
